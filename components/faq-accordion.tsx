...
const faqItems: FAQItem[] = [
  ...
  {
    question: "Alright, but is this even technically possible? Won't my data get stolen?",
    answer:
  ...
  },
  {
    ...
    answer:
      "We plan to secure funding through blockchain token sales, possibly using a launchpad. Later, access to the AI will be subscription-based. Tokens purchased on the blockchain will also serve as payment for Kronos AI access.",
  },
]
    ...
    <section className="py-20 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl md:text-4xl font-bold text-center mb-16 font-mono text-purple-400/80"
        >
        ...
        <div className="space-y-4">
          {faqItems.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-lg font-mono font-medium text-white">{item.question}</span>
              ...
              <AnimatePresence>
                {activeIndex === index && (
                  ...
                  >
                    <div className="p-6 pt-0 text-gray-300 whitespace-pre-line">{item.answer}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
